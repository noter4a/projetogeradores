                    ...
                    {(() => {
                      ...
                      if (!hasValidDate) return (
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full border text-xs font-bold transition-all hover:brightness-125 bg-gray-800 border-gray-700 text-gray-400 hover:text-white hover:border-gray-500"
